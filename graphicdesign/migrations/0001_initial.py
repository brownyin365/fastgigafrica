    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='graphicdesign.Category')),
            ],
        ),
        migrations.CreateModel(
            name='Review_Design',
        ...
        migrations.AddField(
            model_name='graphicpost',
            name='sub_category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='graphicdesign.Sub_Category'),
        ),
    ]
